    ...
    def parse(self):
        ...
        with open(self.location) as bed_file:
            for line in bed_file:
                ...
                # Check format #
                if len(line) < 3:
                    raise gm_err.ParsingError("400", "The bed track " + self.name + " does not seem to be a valid interval file")
                # Chromosome #
                feature['chr'] = line[0]
                # Start and end #
        ...
        for feature in all_features:
            if feature['start'] >= feature['end']:
                raise gm_err.ParsingError("400", "The bed track " + self.name + " seems to contain negative or null intervals")
